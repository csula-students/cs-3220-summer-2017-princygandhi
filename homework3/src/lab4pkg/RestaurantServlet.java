 ...
 */
@WebServlet(loadOnStartup=1, urlPatterns={"/lab4/restaurant"})
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(int i = 0; i < entries.size(); i++)
		{
			...
			if(qty > 0)
			{
				...
				orderEntries.add(new Order(orderEntries.size(),leEntry,"Princy", Statuses.IN_PROGRESS.toString(),new java.util.Date(System.currentTimeMillis()),qty,(qty * leEntry.getPrice())));
			}
		}
